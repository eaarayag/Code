#!/usr/bin/env python3
"""Send L2 regression report email using config/email_config_tap.ini."""
...
CONFIG_PATH = os.path.join(ROOT_DIR, "config", "email_config_tap.ini")
...
def main():
    parser = argparse.ArgumentParser(description="Send L2 TAP regression report email")
